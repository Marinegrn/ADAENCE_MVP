      ...
      <header className="bg-white shadow-sm px-4 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center">
            <span className="text-2xl font-bold text-gray-800">Ada</span>
            <span className="text-2xl font-bold text-indigo-600">ence</span>
          </div>
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-gray-600 hover:text-gray-900">Accueil</a>
            <a href="#" className="text-gray-600 hover:text-gray-900">Je rends visite</a>
            <a href="#" className="text-gray-600 hover:text-gray-900">Guide du partage</a>
            <a href="#" className="text-gray-600 hover:text-gray-900">Devenir bénévole</a>
          </nav>
